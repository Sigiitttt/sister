...
// import { ChevronDown, ChevronUp, Copy, Printer, Mountain } from 'lucide-react';
// import { Link } from 'react-router-dom';

// // Mengubah nama komponen agar sesuai dengan nama file dan router
// const PanduanPage = () => {
...
//             color: 'from-emerald-400 to-cyan-500', // Tema utama
//             points: [
...
//             // PERBAIKAN: Warna diselaraskan (menggunakan warna yang lebih netral/tegas)
...
//         // Menggunakan document.execCommand untuk kompatibilitas yang lebih luas di dalam iframe
...
//     return (
//         <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 text-slate-800 px-4 py-10">
//             <header className="max-w-4xl mx-auto text-center mb-10">
//                 <div className="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-400 to-cyan-500 px-5 py-3 rounded-2xl shadow-md text-white">
//                     <Mountain className="w-6 h-6" />
//                     <h1 className="font-extrabold text-2xl">SOP Pendakian Gunung Penanggungan</h1>
//                 </div>
//                 <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
//                     Panduan resmi untuk keselamatan, keamanan, dan pelestarian alam selama pendakian Gunung Penanggungan.
//                 </p>
//                 <div className="flex justify-center gap-3 mt-5">
//                     <button onClick={() => window.print()} className="flex items-center gap-2 bg-slate-800 text-white px-4 py-2 rounded-xl shadow hover:opacity-90 transition-opacity">
//                         <Printer className="w-4 h-4" /> Cetak SOP
//                     </button>
//                     <button
//                         onClick={copyToClipboard}
//                         className="flex items-center gap-2 bg-emerald-500 text-white px-4 py-2 rounded-xl shadow hover:opacity-90 transition-opacity"
//                     >
...
//                             className={`w-full flex justify-between items-center px-6 py-4 bg-gradient-to-r ${section.color} text-white font-semibold text-left text-lg`}
//                         >
//                             {section.title}
...
//                                         <div className="w-2.5 h-2.5 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 mt-1.5 flex-shrink-0"></div>
...
//                 <p>© {new Date().getFullYear()} Pengelola Gunung Penanggungan. Jaga alam, jaga keselamatan.</p>
//                 <Link to="/" className="text-cyan-600 hover:underline font-semibold mt-2 inline-block">
